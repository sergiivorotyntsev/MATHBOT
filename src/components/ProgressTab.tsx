...
export const ProgressTab: React.FC<ProgressTabProps> = ({
  ...
  return (
    <div className="space-y-6">
      ...
      {/* === BLOCK 3: MATH SKILLS - Removed legacy dashboard (avatar.mathSkills), now using MathSkillsPanel in BLOCK 4 === */}

      {/* Legacy avatar-based skills removed - was showing hardcoded percentages that didn't update.
          Now using real-time question service data in MathSkillsPanel below. */}
